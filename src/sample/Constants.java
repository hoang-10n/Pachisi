...
public class Constants {
     ...
     */
//    public static final int[] SPAWN_POS = new int[]{15, 15, 15, 15};//TODO for testing kick, change this back when done
    ...
    // show all the value of dice that allow a player to leave the nest
    public static final int[] LEAVE_NEST_DIE = new int[]{6};
...
//            {-36, 12, 60, 108, 156, 204, 252, 252, 252, 252, 252, 252, 252, 317, 382, 382, 382, 382, 382, 382, 382, 430, 478, 526, 574, 622, 670, 670, 670, 622, 574, 526, 478, 430, 382, 382, 382, 382, 382, 382, 382, 317, 252, 252, 252, 252, 252, 252, 252, 204, 156, 108, 60, 12, -36, -36}};
    ...
    public static final int[] die1OriginalPos = new int[] {356, 354};
    public static final int[] die2OriginalPos = new int[] {356, 354};
}
